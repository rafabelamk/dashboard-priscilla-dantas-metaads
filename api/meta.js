...
const AD_ACCOUNTS = [
  'act_1519004369175892',   // conta principal — campanhas pausadas mas dados históricos preservados
...
async function fetchAccount(account, produto, sinceDate, untilDate, TOKEN, getAction) {
  ...
  if (campaignData.error) return null; // ignora conta com erro (pausada, sem permissão, etc)
